/*
If you improve this software or find a bug, please let me know
Project home page: http://escapecode.github.com/texasholdem
*/
"use strict";
...
function new_game_continues (req_no_opponents) {
  var my_players = [
                    new player("Jim", 0, "", "", "", 0, 0),
                    new player("Chiffon", 0, "", "", "", 0, 0),
                    new player("Talia", 0, "", "", "", 0, 0),
                    new player("Vinny", 0, "", "", "", 0, 0),
                    new player("Mei", 0, "", "", "", 0, 0),
                    new player("Smokie", 0, "", "", "", 0, 0),
                    new player("Tiny", 0, "", "", "", 0, 0),
                    new player("Ginger", 0, "", "", "", 0, 0),
...
for (var x = 0; x < 20; x++)
{
  ...
  randompokerchips = 0;
	...
	for (var botnum=1; botnum < 9; botnum++)
	{
      document.getElementById("avatar" + botnum).src = "avatar/_bot" + botnum + "_normal.png";
	}
...
function main () {
 ...
 if (players[current_bettor_index].status == "BUST" ||
    ...
    if (current_bettor_index == 0) {
      ...
      var html9 = "<td><table align=right><tr><td align=center>";
...
function the_bet_function (player_index, bet_amount) {
  if (players[player_index].status == "FOLD") {
    ...
    players[player_index].status = "CALL";
               if (player_index == 0)
               document.getElementById("mybet").style.background = "#050505";
               if (player_index == 1)
               document.getElementById("bbet1").style.background = "#050505";
               if (player_index == 2)
               document.getElementById("bbet2").style.background = "#050505";
               if (player_index == 3)
               document.getElementById("bbet3").style.background = "#050505";
               if (player_index == 4)
               document.getElementById("bbet4").style.background = "#050505";
               if (player_index == 5)
               document.getElementById("bbet5").style.background = "#050505";
               if (player_index == 6)
               document.getElementById("bbet6").style.background = "#050505";
               if (player_index == 7)
               document.getElementById("bbet7").style.background = "#050505";
               if (player_index == 8)
               document.getElementById("bbet8").style.background = "#050505";
               if (player_index == 9)
               document.getElementById("bbet9").style.background = "#050505";
  ...
  if (b >= players[x].bankroll) { // ALL IN
    ...
    players[x].status = "FOLD";
               ...
               document.getElementById(avatarname).src = avatarimage;
				...
				document.getElementById("bbet9").style.background = "transparent";
  } else if (b == n) { // CALL
   ...
   // audio2.play();
    bet_text = "ALL IN (" +
              ...
              if (n > 0 && n < 10)
              {
               ...
               var avatarname = "avatar" + botarray[y];
               var avatarimage = "avatar/_bot" + botarray[y] + "_call.png";
               document.getElementById(avatarname).src = avatarimage;
               $("#botspeech" + n).text("All In...");
               $("#botspeech1" + n).show().delay(5000).fadeOut();
               document.getElementById("bbet" + n).style.background = "red";
				}
...
function update_func () {
  var url = 'https://escapecode.github.com/texasholdem';
  var win = window.open(url, '_blank');
  win.focus();
}
